...
public final class OrderItemCursor extends Cursor<OrderItem> {
    ...
    public long put(OrderItem entity) {
        ...
        collect313311(cursor, 0, 0,
                ...
                __ID_snapshot_quantity, entity.snapshot_quantity, __ID_snapshot_preparationTime, entity.snapshot_preparationTime,
                __ID_isDone, entity.isDone ? 1 : 0, __ID_snapshot_isAvailable, entity.snapshot_isAvailable ? 1 : 0,
                0, 0, __ID_discount, entity.discount);

        collect002033(cursor, 0, 0,
                __ID_snapshot_isDone, entity.snapshot_isDone ? 1 : 0, 0, 0,
                0, 0, 0, 0,
