...
//            try {
//                    DbUser user = userService
//                                    .registerUser(request.getUsername(), request.getEmail(), request.getPassword())
//                                    .get();
//                    Set<String> roleNames = user.getRoles().stream()
//                                    .map(DbRole::getName)
//                                    .collect(Collectors.toSet());
//                    messagingTemplate.convertAndSend("/queue/register",
//                                    new AuthResponse("1", null, "Registration successful", roleNames));
//            } catch (BaseException e) {
//                    messagingTemplate.convertAndSendToUser("/queue/register",
//                                    new AuthResponse(String.valueOf(e.getCode()), null, "Error: " + e.getMessage(),
//                                                    null));
//            } catch (Exception e) {
//                    messagingTemplate.convertAndSendToUser("/queue/register",
//                                    new AuthResponse("-1", null, "Error: " + e.getMessage(), null));
//            }
//        }
        ...
        public void login(@Valid @Payload LoginRequest request, SimpMessageHeaderAccessor headerAccessor) {
            ...
            try {
                ...
                messagingTemplate.convertAndSendToUser(sessionId, "/queue/login",//"/topic/auth",
                                new AuthResponse("1", token, "Login successful", roleNames));
                ...
                messagingTemplate.convertAndSendToUser(sessionId, "/queue/login",//"/topic/auth",
                                new AuthResponse(String.valueOf(code), null, "Error: " + e.getMessage(), null));
            }
        }
        ...
        public void forgotPassword(@Valid @Payload ForgotPasswordRequest request,
            ...
            try {
                ...
                messagingTemplate.convertAndSendToUser(sessionId, "/queue/forgot-password",//"/topic/auth",
                                new AuthResponse("1", null, "Reset link sent if email exists.", null));
            } catch (Exception e) {
                messagingTemplate.convertAndSendToUser(sessionId, "/queue/forgot-password",//"/topic/auth",
                                new AuthResponse("-1", null, "Error: " + e.getMessage(), null));
            }
        ...
        public void resetPassword(@Valid @Payload ResetPasswordRequest request,
            ...
            try {
                ...
                messagingTemplate.convertAndSendToUser(sessionId, "/queue/reset-password",
                                new AuthResponse("1", null, "Password reset successful.", null));
            } catch (Exception e) {
                int code = -1;
